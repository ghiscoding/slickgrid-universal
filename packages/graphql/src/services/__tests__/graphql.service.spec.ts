...
describe('GraphqlService', () => {
      ...
      service.init(
        {
          datasetName: 'users',
          filteringOptions: [
            { field: 'field1', operator: '>', value: '2000-10-10' },
            { field: 'field2', operator: 'EQ', value: 'John' },
          ],
          sortingOptions: [
  ...
  describe('processOnFilterChanged method', () => {
    ...
    it('should throw an error when grid is undefined', () => {
      ...
      expect(() => service.processOnFilterChanged(null as any, { grid: undefined } as any)).toThrow(
        'Something went wrong when trying create the GraphQL Backend Service'
      );
    });
  ...
  describe('presets', () => {
    ...
    it('should return a query without invalid characters to filter a search value that does contains invalid characters', () => {
      ...
      const mockColumnFilters = {
        duration: { columnId: 'duration', columnDef: mockColumnDuration, searchTerms: ['-2a2'], type: 'string' },
      } as ColumnFilters;
