...
export function useCellFormatByFieldType(stylesheet: ExcelStylesheet, stylesheetFormatters: any, columnDef: Column, grid: SlickGridModel, autoDetect = true) {
...
export function getNumericFormatterOptions(columnDef: Column, grid: SlickGridModel, formatterType: FormatterType) {
...
export function getExcelFormatFromGridFormatter(stylesheet: ExcelStylesheet, stylesheetFormatters: any, columnDef: Column, grid: SlickGridModel, formatterType: FormatterType) {
  let format = '';
  let groupType = '';
...
function createExcelFormatFromGridFormatter(columnDef: Column, grid: SlickGridModel, formatterType: FormatterType, groupType = '') {
  let outputFormat = '';
  let positiveFormat = '';
  let negativeFormat = '';
