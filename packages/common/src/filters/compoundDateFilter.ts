...
export class CompoundDateFilter implements Filter {
  ...
  private buildDatePickerInput(searchTerm?: SearchTerm) {
    ...
    let currentLocale = (userFilterOptions && userFilterOptions.locale) || (this.translaterService && this.translaterService.getCurrentLocale && this.translaterService.getCurrentLocale()) || this.gridOptions.locale || 'en';
