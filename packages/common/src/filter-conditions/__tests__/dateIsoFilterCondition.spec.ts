  ...
  describe('when using executeFilterConditionTest method', () => {
    describe('single date filtering', () => {
      it('should return False when no cell value is provided, neither search terms', () => {
        ...
        const options = { dataKey: '', operator: 'EQ', fieldType: 'dateIso', cellValue: '' } as FilterConditionOption;
        const output = executeFilterConditionTest(options, getFilterParsedDates(searchTerms, 'dateIso'));
        expect(output).toBe(false);
      });

      it('should return False when any cell value is provided without any search terms', () => {
        const searchTerms = undefined;
        const options = { dataKey: '', operator: 'EQ', fieldType: 'dateIso', cellValue: '2000-12-25' } as FilterConditionOption;
        const output = executeFilterConditionTest(options, getFilterParsedDates(searchTerms, 'dateIso'));
        expect(output).toBe(false);
      });
      ...
      it('should return False when search term is not a valid date', () => {
        ...
        const options = { dataKey: '', operator: 'EQ', fieldType: 'dateIso', cellValue: '2000-12-25', searchTerms } as FilterConditionOption;
        const output = executeFilterConditionTest(options, getFilterParsedDates(searchTerms, 'dateIso'));
        expect(output).toBe(false);
      });
      ...
      it('should return True when input value provided is equal to the searchTerms', () => {
        ...
        const options = { dataKey: '', operator: 'EQ', fieldType: 'dateIso', cellValue: '1993-12-25', searchTerms } as FilterConditionOption;
        const output = executeFilterConditionTest(options, getFilterParsedDates(searchTerms, 'dateIso'));
      ...
      it('should return False even when Operator is Not Equal and cell value equals the search term', () => {
        const searchTerms = ['1993-12-25'];
        const options = { dataKey: '', operator: 'NE', fieldType: 'dateIso', cellValue: '1993-12-25', searchTerms } as FilterConditionOption;
        const output = executeFilterConditionTest(options, getFilterParsedDates(searchTerms, 'dateIso'));
        expect(output).toBe(false);
      });
      ...
      it('should return False when there are no search term and no operator', () => {
        ...
        const options = { dataKey: '', fieldType: 'dateIso', cellValue: '1993-12-25', searchTerms } as FilterConditionOption;
        const output = executeFilterConditionTest(options, getFilterParsedDates(searchTerms, 'dateIso'));
        expect(output).toBe(false);
      });
    ...
    describe('date range', () => {
      ...
      it('should return True when input value is in the range of search terms', () => {
        const searchTerms = ['1993-12-01..1993-12-31'];
        const options = { dataKey: '', operator: 'EQ', cellValue: '1993-12-25', fieldType: 'dateIso', searchTerms } as FilterConditionOption;
        const output = executeFilterConditionTest(options, getFilterParsedDates(searchTerms, 'dateIso'));
        expect(output).toBe(true);
      });
      ...
      it('should return False when input value is not in the range of search terms', () => {
        const searchTerms = ['1993-12-01..1993-12-31'];
        const options = { dataKey: '', operator: 'EQ', cellValue: '1993-11-25', fieldType: 'dateIso', searchTerms } as FilterConditionOption;
        const output = executeFilterConditionTest(options, getFilterParsedDates(searchTerms, 'dateIso'));
        expect(output).toBe(false);
      });
  ...
  describe('when using executeDateFilterCondition method', () => {
    ...
    describe('date range', () => {
      it('should return True when input value is in the range of search terms', () => {
        const searchTerms = ['1993-12-01..1993-12-31'];
        const options = { dataKey: '', operator: 'EQ', cellValue: '1993-12-25', fieldType: 'dateIso', searchTerms } as FilterConditionOption;
        const output = executeDateFilterCondition(options, getFilterParsedDates(searchTerms, 'dateIso'));
        expect(output).toBe(true);
      });
