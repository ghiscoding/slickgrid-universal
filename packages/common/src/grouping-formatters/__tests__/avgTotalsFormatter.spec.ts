...
describe('avgTotalsFormatter', () => {
  ...
  it('should display an empty string when no value is provided', () => {
    const output = avgTotalsFormatter({}, {} as Column, {} as SlickGridModel);
    expect(output).toBe('');
  });
  ...
  it('should display an empty string when the "avg" does not find the field property in its object', () => {
    ...
    const output = avgTotalsFormatter(totals, columnDef, {} as SlickGridModel);
    expect(output).toBe('');
  });
  ...
  it('should display a negative average when its input is negative', () => {
    ...
    const output1 = avgTotalsFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as SlickGridModel);
    const output2 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2 } } as Column, {} as SlickGridModel);
  ...
  it('should display a negative average and thousand separator when its input is negative', () => {
    ...
    const output1 = avgTotalsFormatter(totals, { id: 'column1', field: 'column1', params: { thousandSeparator: ',' } } as Column, {} as SlickGridModel);
    const output2 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, thousandSeparator: ',' } } as Column, {} as SlickGridModel);
    const output3 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
  ...
  it('should display a negative average with parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = avgTotalsFormatter(totals, { id: 'column1', field: 'column1', params: { displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGridModel);
    const output2 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGridModel);
  ...
  it('should display a negative average with and thousand separator and parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = avgTotalsFormatter(totals, { id: 'column1', field: 'column1', params: { displayNegativeNumberWithParentheses: true, thousandSeparator: ',' } } as Column, {} as SlickGridModel);
    const output2 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, displayNegativeNumberWithParentheses: true, thousandSeparator: ',' } } as Column, {} as SlickGridModel);
    const output3 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, displayNegativeNumberWithParentheses: true, decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
  ...
  it('should display a rounded average number without decimals when no min/maxDecimal is defined and when a positive number is provided', () => {
    ...
    const output1 = avgTotalsFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as SlickGridModel);
    const output2 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2' } as Column, {} as SlickGridModel);
  ...
  it('should display an average number with user defined minimum & maximum decimal count', () => {
    ...
    const output1 = avgTotalsFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2 } } as Column, {} as SlickGridModel);
    const output2 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0 } } as Column, {} as SlickGridModel);
    const output3 = avgTotalsFormatter(totals, { id: 'column3', field: 'column3', params: { minDecimal: 3, displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGridModel);
  ...
  it('should display an average number a prefix and suffix', () => {
    ...
    const output1 = avgTotalsFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterPrefix: 'Avg: ' } } as Column, {} as SlickGridModel);
    const output2 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterSuffix: ' (avg)' } } as Column, {} as SlickGridModel);
  ...
  it('should display an average number with prefix, suffix and thousand separator', () => {
    ...
    const output1 = avgTotalsFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterPrefix: 'Avg: ', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
    const output2 = avgTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterSuffix: ' (avg)', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
    const output3 = avgTotalsFormatter(
      totals, {
