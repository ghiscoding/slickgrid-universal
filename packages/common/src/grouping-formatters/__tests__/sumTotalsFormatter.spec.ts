...
describe('sumTotalsFormatter', () => {
  it('should display an empty string when no value is provided', () => {
    const output = sumTotalsFormatter({}, {} as Column, {} as GridOption);
    expect(output).toBe('');
  });
  ...
  it('should display an empty string when the "sum" does not find the field property in its object', () => {
    ...
    const output = sumTotalsFormatter(totals, columnDef, {} as GridOption);
    expect(output).toBe('');
  });
  ...
  it('should display a negative sum when its input is negative', () => {
    ...
    const output1 = sumTotalsFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as GridOption);
    const output2 = sumTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2 } } as Column, {} as GridOption);
    const output3 = sumTotalsFormatter(
      totals,
      { id: 'column2', field: 'column2', params: { maxDecimal: 2, decimalSeparator: ',' } } as Column,
      {} as GridOption
    );
  ...
  it('should display a negative sum and thousand separator when its input is negative', () => {
    ...
    const output1 = sumTotalsFormatter(totals, { id: 'column1', field: 'column1', params: { thousandSeparator: ',' } } as Column, {} as GridOption);
    const output2 = sumTotalsFormatter(
      totals,
  ...
  it('should display a negative sum with parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = sumTotalsFormatter(
      totals,
  ...
  it('should display a negative sum with thousand separator and parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output3 = sumTotalsFormatter(
      totals,
      {
        id: 'column2',
        field: 'column2',
        params: { maxDecimal: 2, displayNegativeNumberWithParentheses: true, decimalSeparator: ',', thousandSeparator: ' ' },
      } as Column,
      {} as GridOption
    );
  ...
  it('should display a negative sum with parentheses when input is negative and "displayNegativeNumberWithParentheses" is enabled in the Formatter Options', () => {
    ...
    const output = sumTotalsFormatter(totals, columnDef, gridOptions);
  ...
  it('should display the same sum value when a number with decimals is provided', () => {
    ...
    const output1 = sumTotalsFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as GridOption);
    const output2 = sumTotalsFormatter(totals, { id: 'column2', field: 'column2' } as Column, {} as GridOption);
  ...
  it('should display a sum number with user defined minimum & maximum decimal count', () => {
    ...
    const output1 = sumTotalsFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2 } } as Column, {} as GridOption);
    const output2 = sumTotalsFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0 } } as Column, {} as GridOption);
    const output3 = sumTotalsFormatter(
      totals,
  ...
  it('should display an sum number with user defined minimum & maximum decimal count in his grid option', () => {
    ...
    const output1 = sumTotalsFormatter(totals, { id: 'column1', field: 'column1' } as Column, gridOptions);
    const output2 = sumTotalsFormatter(totals, { id: 'column2', field: 'column2' } as Column, gridOptions);
    const output3 = sumTotalsFormatter(totals, { id: 'column3', field: 'column3' } as Column, gridOptions);
