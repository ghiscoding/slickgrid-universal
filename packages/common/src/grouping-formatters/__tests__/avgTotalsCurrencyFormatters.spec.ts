...
describe('avgTotalsCurrencyFormatter', () => {
  ...
  it('should display an empty string when the "avg" does not find the field property in its object', () => {
    ...
    const output = avgTotalsCurrencyFormatter(totals, columnDef, {} as SlickGridModel);
    expect(output).toBe('');
  });
  ...
  it('should display a negative average with Currency sign, comma as decimal separator and underscore as thousand separator when its input is negative', () => {
    const columnDef = { id: 'column3', field: 'column3', params: { decimalSeparator: ',', thousandSeparator: '_', groupFormatterCurrencyPrefix: '€' } } as Column;
    const totals = { avg: { column1: 123, column2: 345, column3: -12345678.45 } };
    const output = avgTotalsCurrencyFormatter(totals, columnDef, {} as SlickGridModel);
  ...
  it('should display an average number with at least 2 decimals but no more than 4 by default, and Currency sign when a positive number is provided', () => {
    ...
    const output1 = avgTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as SlickGridModel);
    const output2 = avgTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€' } } as Column, {} as SlickGridModel);
  ...
  it('should display an average number with user defined minimum & maximum decimal count', () => {
    ...
    const output1 = avgTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2 } } as Column, {} as SlickGridModel);
    const output2 = avgTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterCurrencyPrefix: '€', } } as Column, {} as SlickGridModel);
    const output3 = avgTotalsCurrencyFormatter(totals, { id: 'column3', field: 'column3', params: { minDecimal: 3, groupFormatterCurrencyPrefix: '€', displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGridModel);
  ...
  it('should display an average number with user defined minimum & maximum decimal count in his grid option', () => {
    ...
    const output3 = avgTotalsCurrencyFormatter(totals, { id: 'column3', field: 'column3', params: { groupFormatterCurrencyPrefix: '€', groupFormatterPrefix: 'Avg: ' } } as Column, gridStub);
  ...
  it('should display an average number with prefix and suffix', () => {
    ...
    const output1 = avgTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterCurrencyPrefix: '€', groupFormatterPrefix: 'Avg: ' } } as Column, {} as SlickGridModel);
    const output2 = avgTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterCurrencyPrefix: '€', groupFormatterSuffix: ' (avg)' } } as Column, {} as SlickGridModel);
    const output3 = avgTotalsCurrencyFormatter(
      totals, {
        id: 'column3', field: 'column3',
        params: { minDecimal: 3, displayNegativeNumberWithParentheses: true, groupFormatterCurrencyPrefix: '€', groupFormatterPrefix: 'Avg: ', groupFormatterSuffix: '/item' }
  ...
  it('should display an average number with prefix, suffix and thousand separator', () => {
    ...
    const output1 = avgTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterPrefix: 'Avg: ', groupFormatterCurrencyPrefix: '€', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
    const output2 = avgTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterSuffix: ' (avg)', groupFormatterCurrencyPrefix: '€', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
    const output3 = avgTotalsCurrencyFormatter(
      totals, {
        id: 'column3', field: 'column3',
        params: { minDecimal: 3, displayNegativeNumberWithParentheses: true, groupFormatterPrefix: 'Avg: ', groupFormatterCurrencyPrefix: '€', groupFormatterSuffix: '/item', decimalSeparator: ',', thousandSeparator: '_' }
      } as Column, {} as SlickGridModel);
