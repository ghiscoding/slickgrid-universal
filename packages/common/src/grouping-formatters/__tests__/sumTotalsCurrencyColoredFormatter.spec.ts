...
describe('sumTotalsCurrencyColoredFormatter', () => {
  ...
  it('should display an empty string when no value is provided', () => {
    const output = sumTotalsCurrencyColoredFormatter({}, {} as Column, {} as SlickGridModel);
    expect(output).toBe('');
  });
  ...
  it('should display an empty string when the "sum" does not find the field property in its object', () => {
    ...
    const output = sumTotalsCurrencyColoredFormatter(totals, columnDef, {} as SlickGridModel);
    expect(output).toBe('');
  });
  ...
  it('should display a negative sum with at least 2 decimals in red when its input is negative', () => {
    ...
    const output1 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as SlickGridModel);
    const output2 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2 } } as Column, {} as SlickGridModel);
  ...
  it('should display a negative sum in red and thousand separator when its input is negative', () => {
    ...
    const output1 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€', thousandSeparator: ',' } } as Column, {} as SlickGridModel);
    const output2 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2, thousandSeparator: ',' } } as Column, {} as SlickGridModel);
    const output3 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2, decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
  ...
  it('should display a negative sum in red with parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€', displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGridModel);
    const output2 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2, displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGridModel);
  ...
  it('should display a negative sum in red with thousand separator and parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€', displayNegativeNumberWithParentheses: true, thousandSeparator: ',' } } as Column, {} as SlickGridModel);
    const output2 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, displayNegativeNumberWithParentheses: true, thousandSeparator: ',' } } as Column, {} as SlickGridModel);
    const output3 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2, displayNegativeNumberWithParentheses: true, decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
  ...
  it('should display the same sum value in green with at least 2 decimals when a number with decimals is provided', () => {
    ...
    const output1 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as SlickGridModel);
    const output2 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€' } } as Column, {} as SlickGridModel);
  ...
  it('should display an sum number with user defined minimum & maximum decimal count in his grid option', () => {
    ...
    const output1 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€' } } as Column, gridStub);
    const output2 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2' } as Column, gridStub);
    const output3 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column3', field: 'column3', params: { groupFormatterCurrencyPrefix: '€' } } as Column, gridStub);
  ...
  it('should display a sum number in correct color with at least 2 decimals when user provided minimum & maximum decimal count', () => {
    ...
    const output1 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2 } } as Column, {} as SlickGridModel);
    const output2 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0 } } as Column, {} as SlickGridModel);
    const output3 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column3', field: 'column3', params: { groupFormatterCurrencyPrefix: '€', minDecimal: 3, displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGridModel);
  ...
  it('should display a sum number with at least 2 decimals with prefix and suffix', () => {
    ...
    const output1 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2, groupFormatterPrefix: 'sum: ' } } as Column, {} as SlickGridModel);
    const output2 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', minDecimal: 0, groupFormatterSuffix: ' (max)' } } as Column, {} as SlickGridModel);
    const output3 = sumTotalsCurrencyColoredFormatter(
      totals, {
        id: 'column3',
        field: 'column3',
        params: { minDecimal: 3, displayNegativeNumberWithParentheses: true, groupFormatterCurrencyPrefix: '€', groupFormatterPrefix: 'sum: ', groupFormatterSuffix: '/item' }
      } as Column, {} as SlickGridModel
    );
  ...
  it('should display a sum number with prefix, suffix and thousand separator', () => {
    ...
    const output1 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterCurrencyPrefix: '€', groupFormatterPrefix: 'Sum: ', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
    const output2 = sumTotalsCurrencyColoredFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterCurrencyPrefix: '€', groupFormatterSuffix: ' (sum)', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGridModel);
    const output3 = sumTotalsCurrencyColoredFormatter(
      totals, {
        id: 'column3', field: 'column3',
        params: { minDecimal: 3, displayNegativeNumberWithParentheses: true, groupFormatterPrefix: 'Sum: ', groupFormatterCurrencyPrefix: '€', groupFormatterSuffix: '/item', decimalSeparator: ',', thousandSeparator: '_' }
      } as Column, {} as SlickGridModel);
