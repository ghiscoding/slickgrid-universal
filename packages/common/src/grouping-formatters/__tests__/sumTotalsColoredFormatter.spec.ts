...
describe('sumTotalsColoredFormatter', () => {
  ...
  it('should display an empty string when no value is provided', () => {
    const output = sumTotalsColoredFormatter({}, {} as Column, {} as SlickGrid);
    expect(output).toBe('');
  });
  ...
  it('should display an empty string when the "sum" does not find the field property in its object', () => {
    ...
    const output = sumTotalsColoredFormatter(totals, columnDef, {} as SlickGrid);
    expect(output).toBe('');
  });
  ...
  it('should display a negative sum in red and thousand separator when its input is negative', () => {
    ...
    const output1 = sumTotalsColoredFormatter(totals, { id: 'column1', field: 'column1', params: { thousandSeparator: ',' } } as Column, {} as SlickGrid);
  ...
  it('should display a negative sum with thousand separator and parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = sumTotalsColoredFormatter(totals, { id: 'column1', field: 'column1', params: { displayNegativeNumberWithParentheses: true, thousandSeparator: ',' } } as Column, {} as SlickGrid);
  ...
  it('should display a sum number in green (or red for negative) with user defined minimum & maximum decimal count', () => {
    ...
    const output1 = sumTotalsColoredFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2 } } as Column, {} as SlickGrid);
  ...
  it('should display a sum number a prefix and suffix', () => {
    ...
    const output1 = sumTotalsColoredFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterPrefix: 'sum: ' } } as Column, {} as SlickGrid);
    const output2 = sumTotalsColoredFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterSuffix: ' (max)' } } as Column, {} as SlickGrid);
  ...
  it('should display a sum number with prefix, suffix and thousand separator', () => {
    ...
    const output1 = sumTotalsColoredFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterPrefix: 'Sum: ', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGrid);
    const output2 = sumTotalsColoredFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterSuffix: ' (sum)', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGrid);
    const output3 = sumTotalsColoredFormatter(
      totals, {
