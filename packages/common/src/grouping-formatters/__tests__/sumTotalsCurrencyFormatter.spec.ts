...
describe('sumTotalsCurrencyFormatter', () => {
  ...
  it('should display a negative sum with at least 2 decimals in red when its input is negative', () => {
    ...
    const output2 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2 } } as Column, {} as SlickGrid);
  ...
  it('should display a negative sum with at least 2 decimals and thousand separator when its input is negative', () => {
    ...
    const output1 = sumTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€', thousandSeparator: ',' } } as Column, {} as SlickGrid);
    const output2 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2, thousandSeparator: ',' } } as Column, {} as SlickGrid);
    const output3 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2, decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGrid);
  ...
  it('should display a negative sum in red with at least 2 decimals with parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = sumTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€', displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGrid);
    const output2 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { groupFormatterCurrencyPrefix: '€', maxDecimal: 2, displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGrid);
  ...
  it('should display a negative sum with thousand separator and parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = sumTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€', displayNegativeNumberWithParentheses: true, thousandSeparator: ',' } } as Column, {} as SlickGrid);
    const output2 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, groupFormatterCurrencyPrefix: '€', displayNegativeNumberWithParentheses: true, thousandSeparator: ',' } } as Column, {} as SlickGrid);
    const output3 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, groupFormatterCurrencyPrefix: '€', displayNegativeNumberWithParentheses: true, decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGrid);
  ...
  it('should display a positive sum number with at least 2 decimals, even when displayNegativeNumberWithParentheses is enabled', () => {
    ...
    const output1 = sumTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€', displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGrid);
    const output2 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGrid);
  ...
  it('should display the same sum value in green with at least 2 decimals when a number with decimals is provided', () => {
    ...
    const output1 = sumTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { groupFormatterCurrencyPrefix: '€' } } as Column, {} as SlickGrid);
  ...
  it('should display a sum number in correct color with at least 2 decimals when user provided minimum & maximum decimal count', () => {
    ...
    const output1 = sumTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterCurrencyPrefix: '€' } } as Column, {} as SlickGrid);
    const output2 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0 } } as Column, {} as SlickGrid);
    const output3 = sumTotalsCurrencyFormatter(totals, { id: 'column3', field: 'column3', params: { minDecimal: 3, groupFormatterCurrencyPrefix: '€', displayNegativeNumberWithParentheses: true } } as Column, {} as SlickGrid);
  ...
  it('should display a sum number with at least 2 decimals with prefix and suffix', () => {
    ...
    const output1 = sumTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterCurrencyPrefix: '€', groupFormatterPrefix: 'sum: ' } } as Column, {} as SlickGrid);
    const output2 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterCurrencyPrefix: '€', groupFormatterSuffix: ' (max)' } } as Column, {} as SlickGrid);
  ...
  it('should display a sum number with prefix, suffix and thousand separator', () => {
    ...
    const output1 = sumTotalsCurrencyFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2, groupFormatterPrefix: 'Sum: ', groupFormatterCurrencyPrefix: '€', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGrid);
    const output2 = sumTotalsCurrencyFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0, groupFormatterSuffix: ' (sum)', groupFormatterCurrencyPrefix: '€', decimalSeparator: ',', thousandSeparator: '_' } } as Column, {} as SlickGrid);
    const output3 = sumTotalsCurrencyFormatter(
      totals, {
