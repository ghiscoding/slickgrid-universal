...
describe('sumTotalsDollarColoredFormatter', () => {
  it('should display an empty string when no value is provided', () => {
    const output = sumTotalsDollarColoredFormatter({}, {} as Column, {} as GridOption);
    expect(output).toBe('');
  });
  ...
  it('should display an empty string when the "sum" does not find the field property in its object', () => {
    ...
    const output = sumTotalsDollarColoredFormatter(totals, columnDef, {} as GridOption);
    expect(output).toBe('');
  });
  ...
  it('should display a negative sum with at least 2 decimals in red when its input is negative', () => {
    ...
    const output1 = sumTotalsDollarColoredFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as GridOption);
    const output2 = sumTotalsDollarColoredFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2 } } as Column, {} as GridOption);
  ...
  it('should display a negative sum in red and thousand separator when its input is negative', () => {
    ...
    const output1 = sumTotalsDollarColoredFormatter(
      totals,
      { id: 'column1', field: 'column1', params: { thousandSeparator: ',' } } as Column,
      {} as GridOption
    );
    const output2 = sumTotalsDollarColoredFormatter(
      totals,
  ...
  it('should display a negative sum with parentheses when input is negative and "displayNegativeNumberWithParentheses" is enabled in the Formatter Options', () => {
    ...
    const output = sumTotalsDollarColoredFormatter(totals, columnDef, gridOptions);
  ...
  it('should display the same sum value in green with at least 2 decimals when a number with decimals is provided', () => {
    ...
    const output1 = sumTotalsDollarColoredFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as GridOption);
    const output2 = sumTotalsDollarColoredFormatter(totals, { id: 'column2', field: 'column2' } as Column, {} as GridOption);
  ...
  it('should display an sum number with user defined minimum & maximum decimal count in his grid option', () => {
    ...
    const output1 = sumTotalsDollarColoredFormatter(totals, { id: 'column1', field: 'column1' } as Column, gridOptions);
    const output2 = sumTotalsDollarColoredFormatter(totals, { id: 'column2', field: 'column2' } as Column, gridOptions);
    const output3 = sumTotalsDollarColoredFormatter(totals, { id: 'column3', field: 'column3' } as Column, gridOptions);
  ...
  it('should display a sum number in correct color with at least 2 decimals when user provided minimum & maximum decimal count', () => {
    ...
    const output1 = sumTotalsDollarColoredFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2 } } as Column, {} as GridOption);
    const output2 = sumTotalsDollarColoredFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0 } } as Column, {} as GridOption);
    const output3 = sumTotalsDollarColoredFormatter(
      totals,
