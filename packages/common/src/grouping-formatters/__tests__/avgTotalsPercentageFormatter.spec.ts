...
describe('avgTotalsPercentageFormatter', () => {
  it('should display an empty string when no value is provided', () => {
    const output = avgTotalsPercentageFormatter({}, {} as Column, {} as GridOption);
    expect(output).toBe('');
  });
  ...
  it('should display an empty string when the "avg" does not find the field property in its object', () => {
    ...
    const output = avgTotalsPercentageFormatter(totals, columnDef, {} as GridOption);
    expect(output).toBe('');
  });
  ...
  it('should display a negative percentage average when its input is negative', () => {
    ...
    const output1 = avgTotalsPercentageFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as GridOption);
    const output2 = avgTotalsPercentageFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2 } } as Column, {} as GridOption);
  ...
  it('should display a negative percentage average and thousand separator when its input is negative', () => {
    ...
    const output1 = avgTotalsPercentageFormatter(totals, { id: 'column1', field: 'column1', params: { thousandSeparator: ',' } } as Column, {} as GridOption);
    const output2 = avgTotalsPercentageFormatter(
      totals,
  ...
  it('should display a negative percentage average with parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = avgTotalsPercentageFormatter(
      totals,
  ...
  it('should display a negative average with parentheses when input is negative and "displayNegativeNumberWithParentheses" is enabled in the Formatter Options', () => {
    ...
    const output = avgTotalsPercentageFormatter(totals, columnDef, gridOptions);
  ...
  it('should display a rounded percentage average number without decimals when no min/maxDecimal is defined and a number with decimals is provided', () => {
    ...
    const output1 = avgTotalsPercentageFormatter(totals, { id: 'column1', field: 'column1' } as Column, {} as GridOption);
    const output2 = avgTotalsPercentageFormatter(totals, { id: 'column2', field: 'column2' } as Column, {} as GridOption);
  ...
  it('should display a percentage average number with user defined minimum & maximum decimal count', () => {
    ...
    const output1 = avgTotalsPercentageFormatter(totals, { id: 'column1', field: 'column1', params: { maxDecimal: 2 } } as Column, {} as GridOption);
    const output2 = avgTotalsPercentageFormatter(totals, { id: 'column2', field: 'column2', params: { minDecimal: 0 } } as Column, {} as GridOption);
    const output3 = avgTotalsPercentageFormatter(
      totals,
  ...
  it('should display an average number with user defined minimum & maximum decimal count in his grid option', () => {
    ...
    const output1 = avgTotalsPercentageFormatter(totals, { id: 'column1', field: 'column1' } as Column, gridOptions);
    const output2 = avgTotalsPercentageFormatter(totals, { id: 'column2', field: 'column2' } as Column, gridOptions);
    const output3 = avgTotalsPercentageFormatter(totals, { id: 'column3', field: 'column3' } as Column, gridOptions);
