...
export class Constants {
  static readonly locales: Locale = {
    ...
    TEXT_CLEAR_PINNING: 'Unpin Columns/Rows',
    TEXT_CLONE: 'Clone',
    ...
    TEXT_PIN_COLUMNS_LEFT: 'Pin Through Here (left)',
    TEXT_PIN_COLUMNS_RIGHT: 'Pin Through Here (right)',
    TEXT_PIN_COLUMN: 'Column Pinning',
    TEXT_PIN_LEFT: 'Pin Left',
    TEXT_PIN_RIGHT: 'Pin Right',
    ...
    TEXT_UNPIN_COLUMNS: 'Unpin All Columns',
    TEXT_UNPIN_COLUMN: 'Unpin Column',
