...
export const GlobalGridOptions: Partial<GridOption> = {
  ...
  contextMenu: {
    ...
    hideOptionSection: false,
    iconCollapseAllGroupsCommand: 'sgi sgi-arrow-collapse',
    iconExpandAllGroupsCommand: 'sgi sgi-arrow-expand',
    iconClearGroupingCommand: 'sgi sgi-close',
    iconCopyCellValueCommand: 'sgi sgi-content-copy',
    iconExportCsvCommand: 'sgi sgi-download',
    iconExportExcelCommand: 'sgi sgi-file-excel-outline',
  ...
  gridMenu: {
    ...
    iconClearFrozenColumnsCommand: 'sgi sgi-pin-off-outline',
    iconExportCsvCommand: 'sgi sgi-download',
    iconExportExcelCommand: 'sgi sgi-file-excel-outline',
    iconExportTextDelimitedCommand: 'sgi sgi-download',
    iconRefreshDatasetCommand: 'sgi sgi-sync',
    iconToggleDarkModeCommand: 'sgi sgi-brightness-4',
    iconToggleFilterCommand: 'sgi sgi-flip-vertical',
    iconTogglePreHeaderCommand: 'sgi sgi-flip-vertical',
    menuWidth: 16,
  ...
  headerMenu: {
    ...
    autoAlignOffset: 4,
    minWidth: 140,
    iconClearFilterCommand: 'sgi sgi-filter-remove-outline',
    iconClearSortCommand: 'sgi sgi-sort-variant-off',
    iconFreezeColumns: 'sgi sgi-pin-outline',
    iconSortAscCommand: 'sgi sgi-sort-ascending',
    iconSortDescCommand: 'sgi sgi-flip-v sgi-sort-descending',
    iconColumnHideCommand: 'sgi sgi-close',
    iconColumnResizeByContentCommand: 'sgi sgi-arrow-expand-horizontal',
