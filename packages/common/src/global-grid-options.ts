...
export const GlobalGridOptions: Partial<GridOption> = {
  ...
  contextMenu: {
    ...
    hideOptionSection: false,
    iconCollapseAllGroupsCommand: 'fa fa-compress sgi sgi-arrow-collapse',
    iconExpandAllGroupsCommand: 'fa fa-expand sgi sgi-arrow-expand',
    iconClearGroupingCommand: 'fa fa-times sgi sgi-close',
    iconCopyCellValueCommand: 'fa fa-clone sgi sgi-content-copy',
    iconExportCsvCommand: 'fa fa-download sgi sgi-download',
    iconExportExcelCommand: 'fa fa-file-excel-o sgi sgi-file-excel-outline',
    iconExportTextDelimitedCommand: 'fa fa-download sgi sgi-download',
    showBulletWhenIconMissing: true,
    subItemChevronClass: 'sgi sgi-chevron-down sgi-rotate-270',
  },
  customFooterOptions: {
  ...
  gridMenu: {
    ...
    iconCssClass: 'fa fa-bars sgi sgi-menu',
    iconClearAllFiltersCommand: 'fa fa-filter sgi sgi-filter-remove-outline',
    iconClearAllSortingCommand: 'fa fa-unsorted sgi sgi-swap-vertical',
    iconClearFrozenColumnsCommand: 'fa fa-times sgi sgi-pin-off-outline',
    iconExportCsvCommand: 'fa fa-download sgi sgi-download',
    iconExportExcelCommand: 'fa fa-file-excel-o sgi sgi-file-excel-outline',
    iconExportTextDelimitedCommand: 'fa fa-download sgi sgi-download',
    iconRefreshDatasetCommand: 'fa fa-refresh sgi sgi-sync',
    iconToggleDarkModeCommand: 'fa fa-moon-o sgi sgi-brightness-4',
    iconToggleFilterCommand: 'fa fa-random sgi sgi-flip-vertical',
    iconTogglePreHeaderCommand: 'fa fa-random sgi sgi-flip-vertical',
    menuWidth: 16,
  ...
  headerMenu: {
    ...
    autoAlignOffset: 4,
    minWidth: 140,
    iconClearFilterCommand: 'fa fa-filter sgi sgi sgi-filter-remove-outline',
    iconClearSortCommand: 'fa fa-unsorted sgi sgi-swap-vertical',
    iconFreezeColumns: 'fa fa-thumb-tack sgi sgi-pin-outline',
    iconSortAscCommand: 'fa fa-sort-amount-asc sgi sgi-flip-v sgi-sort-ascending',
    iconSortDescCommand: 'fa fa-sort-amount-desc sgi sgi-flip-v sgi-sort-descending',
    iconColumnHideCommand: 'fa fa-times sgi sgi-close',
    iconColumnResizeByContentCommand: 'fa fa-arrows-h sgi sgi-arrow-expand-horizontal',
