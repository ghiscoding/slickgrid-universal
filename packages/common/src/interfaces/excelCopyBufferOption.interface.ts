...
export interface ExcelCopyBufferOption<T = any> {
  ...
  dataItemColumnValueExtractor?: (
    ...
    row?: number,
    cell?: number
  ) => string | HTMLElement | DocumentFragment | FormatterResultWithHtml | FormatterResultWithText | null;
  ...
  dataItemColumnValueSetter?: (
    ...
    columnDef: Column<T>,
    value: any
  ) => string | FormatterResultWithHtml | FormatterResultWithText | null | true;
