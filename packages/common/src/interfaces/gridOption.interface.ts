...
export interface GridOption {
  ...
  /** Defaults to 2 (or 5 in Salesforce), how many good resize count do we require before we assume that it's all good and we can stop calling a resize of the grid? (only works when `autoFixResizeWhenBrokenStyleDetected` is enabled) */
