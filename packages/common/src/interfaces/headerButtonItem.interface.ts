...
export interface HeaderButtonItem {
  ...
  action?: (event: Event, callbackArgs: { command: string; button: any; column: Column; grid: SlickGridUniversal; }) => void;

  /** Callback method that user can override the default behavior of showing/hiding an item from the list. */
  itemVisibilityOverride?: (args: { node: any; column: Column; grid: SlickGridUniversal; }) => boolean;

  /** Callback method that user can override the default behavior of enabling/disabling an item from the list. */
  itemUsabilityOverride?: (args: { node: any; column: Column; grid: SlickGridUniversal; }) => boolean;
}
