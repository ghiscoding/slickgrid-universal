...
/**
 * When value is filled, or if the value is a number and is bigger than 0, it will display a Material Design check icon (sgi-check).
...
export const checkmarkMaterialFormatter: Formatter = (_row, _cell, value) => {
  ...
  return isChecked ? createDomElement('i', { className: 'sgi sgi-18px sgi-check checkmark-icon', ariaHidden: 'true' }) : '';
};
