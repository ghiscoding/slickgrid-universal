...
describe('the ArrayObjectToCsv Formatter', () => {
  ...
  it('should throw an error when omitting to pass "propertyNames" to "params"', () => {
    const params = { mask: '' };
    expect(() => maskFormatter(0, 0, 'anything', { field: 'user', params } as Column, {}, {} as GridOption)).toThrow(
  ...
  it('should return null when no value is provided', () => {
    ...
    const result = maskFormatter(0, 0, input, { field: 'user', params } as Column, {}, {} as GridOption);
  ...
  it('should return formatted output according to mask when mask includes only numbers', () => {
    ...
    const result = maskFormatter(0, 0, inputValue, { field: 'user', params } as Column, {}, {} as GridOption);
  ...
  it('should wrap the formatter output in a span element when "allowDocumentFragmentUsage" grid option is disabled', () => {
    ...
    const result = maskFormatter(0, 0, inputValue, { field: 'user', params } as Column, {}, { preventDocumentFragmentUsage: true } as GridOption);
