...
describe('the Currency Formatter', () => {
  ...
  it('should display an empty string when no value is provided', () => {
    const output = currencyFormatter(1, 1, '', {} as Column, {}, {} as GridOption);
    expect(output).toBe('');
  });

  it('should display original string when non-numeric value is provided', () => {
    const output = currencyFormatter(1, 1, 'hello', {} as Column, {}, {} as GridOption);
    expect(output).toBe('hello');
  });

  it('should display €0 when number 0 is provided', () => {
    const input = 0;
    const output = currencyFormatter(1, 1, input, {} as Column, {}, {} as GridOption);
  ...
  it('should display a decimal number with a prefix when numberPrefix is provided', () => {
    const input = 99;
    const output = currencyFormatter(1, 1, input, { params: { numberPrefix: 'USD ' } } as Column, {}, {} as GridOption);
    expect(output).toBe('USD 99.00');
  });

  it('should display a negative decimal number with a prefix when numberPrefix is provided', () => {
    const input = -99;
    const output = currencyFormatter(1, 1, input, { params: { currencyPrefix: '€' } } as Column, {}, {} as GridOption);
    expect(output).toBe('-€99.00');
  });

  it('should display a negative decimal number with a prefix when numberPrefix is provided', () => {
    const input = -99;
    const output = currencyFormatter(1, 1, input, { params: { numberPrefix: '€' } } as Column, {}, {} as GridOption);
    expect(output).toBe('€-99.00');
  });

  it('should display a negative decimal number with a prefix when currencyPrefix and numberPrefix are provided', () => {
    const input = -99;
    const output = currencyFormatter(1, 1, input, { params: { currencyPrefix: '€', numberPrefix: 'Price ' } } as Column, {}, {} as GridOption);
  ...
  it('should display a negative decimal number with a prefix when numberPrefix is provided', () => {
    ...
    const output = currencyFormatter(
      ...
      1,
      input,
      { params: { displayNegativeNumberWithParentheses: true, currencyPrefix: '€' } } as Column,
      {},
      {} as GridOption
    );
    expect(output).toBe('(€99.00)');
  ...
  it('should display a negative decimal number with a prefix when numberPrefix is provided', () => {
    ...
    const output = currencyFormatter(
      ...
      1,
      input,
      { params: { displayNegativeNumberWithParentheses: true, numberPrefix: '€' } } as Column,
      {},
      {} as GridOption
    );
    expect(output).toBe('€(99.00)');
  ...
  it('should display a decimal number with a prefix when numberSuffix is provided', () => {
    const input = 99;
    const output = currencyFormatter(1, 1, input, { params: { numberSuffix: ' USD' } } as Column, {}, {} as GridOption);
  ...
  it('should display a negative decimal number with a suffix when currencySuffix and numberSuffix are provided', () => {
    const input = -99;
    const output = currencyFormatter(1, 1, input, { params: { currencySuffix: '€', numberSuffix: ' EUR' } } as Column, {}, {} as GridOption);
  ...
  it('should display a decimal number with and use "minDecimal" params', () => {
    const input = 99.1;
    const output = currencyFormatter(1, 1, input, { params: { minDecimal: 2 } } as Column, {}, {} as GridOption);
  ...
  it('should display a decimal number with and use "minDecimal" params', () => {
    ...
    const output1 = currencyFormatter(1, 1, input, { params: { minDecimal: 2 } } as Column, {}, {} as GridOption);
    const output2 = currencyFormatter(1, 1, input, { params: { decimalPlaces: 2 } } as Column, {}, {} as GridOption);
    const output3 = currencyFormatter(1, 1, input, { params: { decimalPlaces: 2, thousandSeparator: ',' } } as Column, {}, {} as GridOption);
    const output4 = currencyFormatter(
      1,
      1,
      input,
      { params: { decimalPlaces: 2, decimalSeparator: ',', thousandSeparator: ' ' } } as Column,
      {},
      {} as GridOption
    );
  ...
  it('should display a decimal number with and use "maxDecimal" params', () => {
    ...
    const output = currencyFormatter(1, 1, input, { params: { maxDecimal: 3 } } as Column, {}, {} as GridOption);
  ...
  it('should display a negative number with parentheses when "displayNegativeNumberWithParentheses" is enabled in the "params"', () => {
    const input = -2.4;
    const output = currencyFormatter(1, 1, input, { params: { displayNegativeNumberWithParentheses: true } } as Column, {}, {} as GridOption);
  ...
  it('should display a negative average with parentheses when input is negative and "displayNegativeNumberWithParentheses" is enabled in the Formatter Options', () => {
    const input = -2.4;
    const output = currencyFormatter(1, 1, input, {} as Column, {}, {
