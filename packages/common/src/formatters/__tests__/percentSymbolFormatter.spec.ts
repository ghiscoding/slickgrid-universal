...
describe('the Percent Symbol Formatter', () => {
  it('should display an empty string when no value is provided', () => {
    const output = percentSymbolFormatter(1, 1, '', {} as Column, {}, {} as GridOption);
    expect(output).toBe('');
  });

  it('should display original string when non-numeric value is provided', () => {
    const output = percentSymbolFormatter(1, 1, 'hello', {} as Column, {}, {} as GridOption);
    expect(output).toBe('hello');
  });

  it('should display 0% when number 0 is provided', () => {
    const input = 0;
    const output = percentSymbolFormatter(1, 1, input, {} as Column, {}, {} as GridOption);
  ...
  it('should display a number with thousand separator and  percentage sign when a number is provided', () => {
    const input = 2345678;
    const output = percentSymbolFormatter(1, 1, input, { params: { thousandSeparator: ',' } } as Column, {}, {} as GridOption);
  ...
  it('should display a negative number with parentheses when "displayNegativeNumberWithParentheses" is enabled in the "params"', () => {
    const input = -2.4;
    const output = percentSymbolFormatter(1, 1, input, { params: { displayNegativeNumberWithParentheses: true } } as Column, {}, {} as GridOption);
  ...
  it('should display a negative number with thousand separator and parentheses when "displayNegativeNumberWithParentheses" is enabled in the "params"', () => {
    ...
    const output = percentSymbolFormatter(
      1,
      1,
      input,
