...
describe('the DollarColored Formatter', () => {
  it('should return an empty string when no value is provided', () => {
    const output = dollarColoredFormatter(1, 1, '', {} as Column, {}, {} as GridOption);
    expect(output).toBe('');
  });

  it('should display original string when non-numeric value is provided', () => {
    const output = dollarColoredFormatter(1, 1, 'hello', {} as Column, {}, {} as GridOption);
    expect(output).toBe('hello');
  });

  it('should display a green number with dollar symbol formatter when number 0 is provided', () => {
    const input = 0;
    const output = dollarColoredFormatter(1, 1, input, {} as Column, {}, {} as GridOption);
  ...
  it('should display a red number with dollar symbol and thousand separator when value is a negative number', () => {
    ...
    const output = dollarColoredFormatter(1, 1, input, { params: { thousandSeparator: ',' } } as Column, {}, {} as GridOption);
  ...
  it('should display a number with dollar sign and use minimum decimal set', () => {
    const input = 99.1;
    const output = dollarColoredFormatter(1, 1, input, { params: { minDecimal: 2 } } as Column, {}, {} as GridOption);
  ...
  it('should display a number with dollar sign and use maximum decimal set', () => {
    ...
    const output = dollarColoredFormatter(1, 1, input, { params: { maxDecimal: 3 } } as Column, {}, {} as GridOption);
  ...
  it('should display a negative number with parentheses when "displayNegativeNumberWithParentheses" is enabled in the "params"', () => {
    const input = -2.4;
    const output = dollarColoredFormatter(1, 1, input, { params: { displayNegativeNumberWithParentheses: true } } as Column, {}, {} as GridOption);
  ...
  it('should display a negative average with parentheses when input is negative and "displayNegativeNumberWithParentheses" is enabled in the Formatter Options', () => {
    const input = -2.4;
    const output = dollarColoredFormatter(1, 1, input, {} as Column, {}, { formatterOptions: { displayNegativeNumberWithParentheses: true } } as GridOption);
    expect((output as HTMLElement).outerHTML).toBe(`<span aria-hidden="true" style="color: red;">($2.40)</span>`);
  });
