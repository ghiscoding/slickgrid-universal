...
describe('the CollectionEditor Formatter', () => {
  ...
  it('should return same output when no value is passed', () => {
    ...
    const result = collectionEditorFormatter(0, 0, valueArray, {} as Column, {}, {} as any);
  ...
  it('should return original value when input is not an array', () => {
    ...
    const result = collectionEditorFormatter(0, 0, inputValue, {} as Column, {}, {} as any);
  ...
  it('should return a string when provided input value is an object', () => {
    const inputValue = 2;
    const result = collectionEditorFormatter(0, 0, inputValue, columnDef, {}, {} as any);
