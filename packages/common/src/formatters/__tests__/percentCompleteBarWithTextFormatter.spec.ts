...
describe('the Percent Complete with Text Formatter', () => {
  it('should return an empty string when no value is provided', () => {
    const output = percentCompleteBarWithTextFormatter(1, 1, '', {} as Column, {}, {} as GridOption);
    expect(output).toBe('');
  });

  it('should return empty string when non-numeric value is provided', () => {
    const output = percentCompleteBarWithTextFormatter(1, 1, 'hello', {} as Column, {}, {} as GridOption);
    expect(output).toBe('');
  });
  ...
  it('should display a red color bar formatter when number 0 is provided', () => {
    const input = 0;
    const color = 'red';
    const output = percentCompleteBarWithTextFormatter(1, 1, input, {} as Column, {}, {} as GridOption);
  ...
  it('should display a silver color bar when value is between 30 and 69', () => {
    ...
    const input2 = 69;
    const color = 'silver';
    const output1 = percentCompleteBarWithTextFormatter(1, 1, input1, {} as Column, {}, {} as GridOption);
    const output2 = percentCompleteBarWithTextFormatter(1, 1, input2, {} as Column, {}, {} as GridOption);
