...
describe('the Progress Bar Formatter', () => {
  ...
  it('should display a red color bar formatter when number 0 is provided', () => {
    ...
    const output = progressBarFormatter(1, 1, inputValue, {} as Column, {}, {} as any);
  ...
  it('should display a red color bar when value is between 30 and 69', () => {
    ...
    const output1 = progressBarFormatter(1, 1, inputValue1, {} as Column, {}, {} as any);
    const output2 = progressBarFormatter(1, 1, inputValue2, {} as Column, {}, {} as any);
