import { CellArgs, Column, DataView, GridOption, OnEventArgs, SlickEventHandler } from './../interfaces/index';
...
export class GridEventService {
  ...
  /* OnCellChange Event */
  bindOnBeforeEditCell(grid: any, dataView: DataView) {
  ...
  /* OnCellChange Event */
  bindOnCellChange(grid: any, dataView: DataView) {
  ...
  /* OnClick Event */
  bindOnClick(grid: any, dataView: DataView) {
