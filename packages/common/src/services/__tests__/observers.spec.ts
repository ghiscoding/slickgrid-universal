...
describe('Service/Observers', () => {
  describe('collectionObserver method', () => {
    it('should watch for array "pop" change and expect callback to be executed', () =>
    ...
    it('should watch for array "push" change and expect callback to be executed', () =>
      new Promise((done: any) => {
        const expectation = [
          { value: true, label: 'True' },
          { value: false, label: 'False' },
    ...
    it('should watch for array "unshift" change and expect callback to be executed', () =>
      new Promise((done: any) => {
        const expectation = [
          { value: '', label: '' },
          { value: true, label: 'True' },
    ...
    it('should watch for array "reverse" change and expect callback to be executed', () =>
      new Promise((done: any) => {
        const expectation = [
    ...
    it('should watch for array "sort" change and expect callback to be executed', () =>
      new Promise((done: any) => {
        const expectation = [
          { id: 1, value: false, label: 'False' },
          { id: 2, value: true, label: 'True' },
  ...
  describe('propertyObserver method', () => {
    it('should watch for an object property change and expect the callback to be executed with new value', () =>
      new Promise((done: any) => {
