  ...
  describe('Tree Data View', () => {
    ...
    describe('Hierarchical Dataset', () => {
      ...
      const expectedSortedAscDataset = [
        { __parentId: null, dateModified: '2012-03-05T12:44:00.123Z', file: 'bucket-list.txt', id: 24, size: 0.5 },
        { __parentId: null, file: 'documents', id: 21 },
        { __parentId: 21, file: 'misc', id: 9 },
        { __parentId: 9, dateModified: '2015-02-26T16:50:00.123Z', file: 'todo.txt', id: 10, size: 0.4 },
        { __parentId: 21, file: 'pdf', id: 4 },
        { __parentId: 4, dateModified: '2015-05-12T14:50:00.123Z', file: 'internet-bill.pdf', id: 6, size: 1.4 },
        { __parentId: 4, dateModified: '2015-05-21T10:22:00.123Z', file: 'map.pdf', id: 5, size: 3.1 },
        { __parentId: 4, dateModified: '2015-05-01T07:50:00.123Z', file: 'phone-bill.pdf', id: 23, size: 1.4 },
        { __parentId: 21, file: 'txt', id: 2 },
        { __parentId: 2, dateModified: '2015-05-12T14:50:00.123Z', file: 'todo.txt', id: 3, size: 0.7 },
        { __parentId: 21, file: 'xls', id: 7 },
        { __parentId: 7, dateModified: '2014-10-02T14:50:00.123Z', file: 'compilation.xls', id: 8, size: 2.3 },
        { __parentId: null, dateModified: '2015-03-03T03:50:00.123Z', file: 'something.txt', id: 18, size: 90 },
      ];
