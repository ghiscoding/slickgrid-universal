...
export class SlickFooterComponent {
  ...
  renderMetrics(metrics: Metrics) {
    ...
    const lastUpdateTimestamp = metrics?.endTime ? format(metrics.endTime, this.customFooterOptions.dateFormat) : '';
  ...
  protected createFooterLastUpdate(): HTMLSpanElement {
    ...
    const lastUpdateTimestamp = this.metrics?.endTime ? format(this.metrics?.endTime, this.customFooterOptions.dateFormat) : '';
