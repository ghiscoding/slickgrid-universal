...
### Demo
[Demo](https://ghiscoding.github.io/slickgrid-universal/#/example14) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/vanilla/src/examples/example14.ts)
