...
### Demo
[Demo Page](https://ghiscoding.github.io/slickgrid-universal/#/example47) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/vanilla/src/examples/example47.ts)
