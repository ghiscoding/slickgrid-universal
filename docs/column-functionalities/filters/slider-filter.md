...
### Demo
##### Single Slider
[Demo Page - Example 02](https://ghiscoding.github.io/slickgrid-universal/#/example02) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/vanilla/src/examples/example02.ts)

##### Slider Range (double handles)
[Demo Page - Example 25](https://ghiscoding.github.io/slickgrid-universal/#/example25) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/vanilla/src/examples/example25.ts)
