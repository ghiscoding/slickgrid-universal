describe('Example 58 - Sticky Financial Report', { retries: 1 }, () => {
  ...
  beforeEach(() => {
    cy.visit(`${Cypress.config('baseUrl')}/example58`);
  });

  it('should display the financial report title and all report columns', () => {
    cy.get('h2').should('contain', 'Example 58: Sticky Financial Report');
