...
/**
 * Financial-report fixture for the sticky docking design discussion.
 *
 * Every docked item in this fixture is scroll-activated: Account, Q1-Q4, and
 * YTD use two-sided sticky docking; the report totals dock below the viewport.
 */
export default class Example47 {
  columns: Column<FinancialRow>[] = [];
  ...
  attached() {
    ...
    this.sgb = new Slicker.GridBundle(
      document.querySelector('.grid47') as HTMLDivElement,
      this.columns,
  ...
  private defineGrid() {
    const createPeriodColumn = (id: PeriodField, name: string, sticky = false): Column<FinancialRow> => ({
      id,
      name,
      field: id,
