  ...
  <h2>
    ...
    <span class="float-end">
      <a
        ...
        target="_blank"
        href="https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/vue/src/components/Example18.vue"
      >
  ...
  <div class="form-inline">
    <div class="row">
      <div class="col-sm-12">
        ...
        <button class="btn btn-outline-secondary btn-xs btn-icon mx-1" data-test="add-500k-rows-btn" @click="loadData(500000)">
          500K rows
        </button>
