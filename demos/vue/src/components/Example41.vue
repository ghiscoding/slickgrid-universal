...
import { type Column, Formatters, SlickGlobalEditorLock, SlickgridVue } from 'slickgrid-vue';
  ...
  <h2>
    ...
    <span class="float-end">
      <a
        ...
        target="_blank"
        href="https://github.com/ghiscoding/slickgrid-vue/blob/main/packages/demo/src/examples/slickgrid/example41.ts"
      >
