...
import type { CursorPageInfo, GridOption, GridStateChange, Metrics, MultipleSelectOption, SlickgridVueInstance } from 'slickgrid-vue';
  ...
  <h2>
    ...
    <span class="float-end">
      <a
        ...
        target="_blank"
        href="https://github.com/ghiscoding/slickgrid-vue/blob/main/packages/demo/src/examples/slickgrid/example6.ts"
      >
