...
import { type Column, DelimiterType, FieldType, FileType, Filters, type Formatter, Formatters, SlickgridVue } from 'slickgrid-vue';
  ...
  <h2>
    ...
    <span class="float-end">
      <a
        ...
        target="_blank"
        href="https://github.com/ghiscoding/slickgrid-vue/blob/main/packages/demo/src/examples/slickgrid/example12.ts"
      >
