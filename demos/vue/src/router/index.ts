...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/example03', name: '3- Editors / Delete', component: Example3 },
  { path: '/example04', name: '4- Client Side Sort/Filter', component: Example4 },
  { path: '/example05', name: '5- Backend OData Service', component: Example5 },
  { path: '/example06', name: '6- Backend GraphQL Service', component: Example6 },
  { path: '/example07', name: '7- Header Button Plugin', component: Example7 },
  { path: '/example08', name: '8- Header Menu Plugin', component: Example8 },
  { path: '/example09', name: '9- Grid Menu Control', component: Example9 },
