...
import './example11.scss'; // provide custom CSS/SASS styling
...
const Example11: React.FC = () => {
  ...
  function defineGrid() {
    const columns: Column[] = [
      {
        id: 'title',
        name: 'Title <span title="Title is always rendered as UPPERCASE" class="fi fi-info"></span>',
        field: 'title',
        sortable: true,
        minWidth: 75,
      ...
      },
      {
        ...
        formatter: () =>
          `<div class="button-style margin-auto" style="width: 35px;"><span class="fi fi-chevron-down text-primary"></span></div>`,
        cellMenu: {
          ...
          commandItems: [
            ...
            'divider',
            {
              ...
              title: 'Delete Row',
              positionOrder: 64,
              iconCssClass: 'fi fi-dismiss color-danger',
              cssClass: 'red',
  ...
  function openCompositeModal(modalType: CompositeEditorModalType) {
    ...
    compositeEditorInstanceRef.current?.openDetails({
      ...
      resetFormButtonIconCssClass: 'fi fi-arrow-undo',
  ...
  function toggleDarkMode() {
    ...
    toggleBodyBackground(isDarkMode);
  ...
  function renderUnsavedCellStyling(item: any, column: Column, editCommand: EditCommand) {
    if (editCommand && item && column) {
      ...
      if (row >= 0) {
        ...
        const cssStyleKey = `unsaved_highlight_${[column.id]}${row}`;
        reactGridRef.current?.slickGrid.setCellCssStyles(cssStyleKey, hash);
  ...
  function renderItemCallbackWith2Rows(item: any): string {
    return `<div class="autocomplete-container-list">
      <div class="autocomplete-left">
        ...
        <span class="fi ${item.icon}"></span>
      </div>
      <div>
        <span class="autocomplete-top-left">
          <span class="fi ${item.itemTypeName === 'I' ? 'fi-info' : 'fi-copy'}"></span>
          ${item.itemName}
        </span>
      <div>
    </div>
  ...
  return !gridOptions ? (
    ...
    <div id="demo-container" className="container-fluid">
      <h2>
        Example 11: Composite Editor Modal
        <Button className="btn-icon ms-2" onClick={() => toggleDarkMode()} data-test="toggle-dark-mode">
      ...
      <div className="mb-2">
        <div className="btn-group btn-group-sm" role="group" aria-label="Basic Editing Commands">
          <Button type="button" className="btn-icon" data-test="toggle-readonly-btn" onClick={() => toggleGridEditReadonly()}>
            <i className="fi fi-table-edit"></i> Toggle Edit/Readonly Grid
          </Button>
          <Button type="button" className="btn-icon mx-1" data-test="undo-last-edit-btn" onClick={() => undoLastEdit()}>
            <i className="fi fi-arrow-undo"></i> Undo Last Edit
          </Button>
          <Button type="button" className="btn-icon" data-test="undo-open-editor-btn" onClick={() => undoLastEdit(true)}>
            <i className="fi fi-arrow-undo"></i> Undo Last Edit &amp; Open Editor
          </Button>
          <Button type="button" className="btn-icon mx-1" data-test="undo-all-edits-btn" onClick={() => undoAllEdits()}>
            <i className="fi fi-history"></i> Undo All Edits
          </Button>
          <Button type="button" className="btn-icon" data-test="save-all-btn" onClick={() => saveAll()}>
            Save All
          </Button>
        </div>
      </div>
      ...
      <div className="mb-3">
        <div className="btn-group btn-group-sm" role="group" aria-label="Basic example">
          ...
          >
            <i className="fi fi-add"></i> Item Create
          </Button>
          <Button
            type="button"
            ...
            disabled={isCompositeDisabled}
          >
            <i className="fi fi-copy"></i> Item Clone
          </Button>
          <Button
            type="button"
            className="btn-icon"
            ...
            disabled={isCompositeDisabled}
          >
            <i className="fi fi-edit"></i> Item Edit
          </Button>
          <Button
            type="button"
            className="btn-icon mx-1"
            ...
            disabled={isCompositeDisabled}
          >
            <i className="fi fi-edit"></i> Mass Update
          </Button>
          <Button
            type="button"
            className="btn-icon"
          ...
          >
            <i className="fi fi-checkbox-checked"></i> Update Selected
          </Button>
        </div>
      </div>
