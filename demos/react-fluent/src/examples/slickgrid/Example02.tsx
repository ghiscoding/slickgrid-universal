...
const Example02: React.FC = () => {
      ...
      const newCols = [
        {
          ...
          params: { iconCssClass: 'fui fui-edit' },
          minWidth: 30,
          maxWidth: 30,
        ...
        },
        {
          ...
          excludeFromHeaderMenu: true,
          formatter: Formatters.icon,
          params: { iconCssClass: 'fui fui-delete pointer' },
          minWidth: 30,
          maxWidth: 30,
  ...
  return !gridOptions ? (
    ...
    <div id="demo-container" className="container-fluid">
      <h2>Example 2: Row Move & Checkbox Selector</h2>
      ...
      <div className="row">
        <div className="col-sm-12">
          ...
          <Button data-test="disable-filters-btn" onClick={() => disableFilters()}>
            Disable Filters
          </Button>
          <Button className="mx-1" data-test="disable-sorting-btn" onClick={() => disableSorting()}>
            Disable Sorting
          </Button>
          <Button data-test="toggle-filtering-btn" onClick={() => toggleFilter()}>
            Toggle Filtering
          </Button>
          <Button className="mx-1" data-test="toggle-sorting-btn" onClick={() => toggleSorting()}>
            Toggle Sorting
          </Button>
          <Button
