# <a href="https://aurelia.io/" rel="nofollow"><img alt="Aurelia" src="https://ghiscoding.github.io/aurelia-slickgrid-demos/assets/aurelia-logo-9YSzF-gF.png" width="60"></a> Aurelia-Slickgrid
...
- [Bootstrap 5 demo](https://ghiscoding.github.io/aurelia-slickgrid) / [examples repo](https://github.com/ghiscoding/aurelia-slickgrid-demos/tree/master/vite-with-i18n)
- [Bootstrap 5 (single Locale)](https://github.com/ghiscoding/aurelia-slickgrid-demos/tree/master/vite-single-locale) / [examples repo](https://github.com/ghiscoding/aurelia-slickgrid-demos/tree/master/vite-single-locale) - Code Sample with a single Locale (without `@aurelia/i18n`)
...
### Like it? ⭐ it
You like **Aurelia-Slickgrid**? Be sure to upvote ⭐ the project, and perhaps support me with caffeine [☕](https://ko-fi.com/ghiscoding) or sponsor me on GitHub. Any contributions are also very welcome. Thanks
...
| :---------------: | --------- | --------------- | ----- | ---- |
| 10.x              | Aurelia 2 | [Migration 10.x](https://ghiscoding.gitbook.io/aurelia-slickgrid/migrations/migration-to-10.x)     | modernization and accessibility, requires Slickgrid-Universal [10.x](https://github.com/ghiscoding/slickgrid-universal/releases/tag/v10.0.0) | 2026-03-02 |
