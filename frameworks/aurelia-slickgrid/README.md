...
| :---------------: | --------- | --------------- | ----- | ---- |
| 10.x              | Aurelia 2 | [Migration 10.x](https://ghiscoding.gitbook.io/aurelia-slickgrid/migrations/migration-to-10.x)     | Smaller code, requires Slickgrid-Universal [10.x](https://github.com/ghiscoding/slickgrid-universal/releases/tag/v10.0.0) | 2026-03-02 |
