...
### Demo
[Demo](https://ghiscoding.github.io/aurelia-slickgrid/#/slickgrid/example24) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/aurelia/src/examples/slickgrid/example24.ts)
