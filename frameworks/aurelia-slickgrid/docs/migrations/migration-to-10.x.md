...
There's also a new Renderer similar to Slots but implemented with native code to make it cross-platform compatible. The usage is actually very similar to how you would use a cell Formatter. You can see a new [Example 51](https://ghiscoding.github.io/aurelia-slickgrid-demos/#/example51) demoing this new feature and also the command builder mentioned above.
