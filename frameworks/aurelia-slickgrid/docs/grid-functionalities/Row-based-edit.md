...
### Demo
[Demo](https://ghiscoding.github.io/aurelia-slickgrid-demos/#/example35) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/aurelia/src/examples/slickgrid/example35.ts)
