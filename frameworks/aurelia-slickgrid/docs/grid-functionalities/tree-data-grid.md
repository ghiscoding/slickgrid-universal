...
### Demo
[Demo Parent/Child Relationship](https://ghiscoding.github.io/aurelia-slickgrid-demos/#/slickgrid/example27) / [ViewModel](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/aurelia/src/examples/slickgrid/example27.ts)

[Hierarchial Dataset](https://ghiscoding.github.io/aurelia-slickgrid-demos/#/slickgrid/example28) / [ViewModel](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/aurelia/src/examples/slickgrid/example28.ts)
...
You would typically use the built-in `Formatters.tree` to show the tree but in some cases you might want to use your own Formatter and that is fine, it's like any other Custom Formatter. Here's a demo of the [Example 28](https://ghiscoding.github.io/aurelia-slickgrid-demos/#/slickgrid/example28) Custom Formatter which is specific for showing the collapsing icon and folder and files icons.
```ts
