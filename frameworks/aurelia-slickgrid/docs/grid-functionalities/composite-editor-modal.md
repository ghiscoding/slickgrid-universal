...
### Demo
[Demo](https://ghiscoding.github.io/aurelia-slickgrid/#/slickgrid/example30) / [Demo Component](https://github.com/ghiscoding/aurelia-slickgrid/blob/master/packages/demo/src/examples/slickgrid/example30.ts)
