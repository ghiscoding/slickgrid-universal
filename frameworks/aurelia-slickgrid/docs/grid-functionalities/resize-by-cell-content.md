...
### Demo
[Demo](https://ghiscoding.github.io/aurelia-slickgrid-demos/#/slickgrid/example32) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/aurelia/src/examples/slickgrid/example32.ts)
