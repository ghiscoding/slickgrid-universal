...
[Context Menu Demo](https://ghiscoding.github.io/aurelia-slickgrid-demos/#/slickgrid/example24) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/aurelia/src/examples/slickgrid/example24.ts)

[Grouping Demo](https://ghiscoding.github.io/aurelia-slickgrid-demos/#/slickgrid/example13) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/aurelia/src/examples/slickgrid/example13.ts)
