describe('Example 26 - Use of Angular Components', () => {
  const fullTitles = [
    'Title',
  ...
  it('should display Example title', () => {
    ...
    cy.get('h2').should('contain', 'Example 26: Use of Angular Components');
  });
  ...
  it('should click on the last column "Action" dropdown of 2nd row, and then "Delete Row" and expect it to be removed from the grid', () => {
    ...
    cy.get('#grid26').find('.slick-row:nth(1) .slick-cell:nth(7)').contains('Action').click({ force: true });
