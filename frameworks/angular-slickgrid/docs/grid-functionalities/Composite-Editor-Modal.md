...
### Demo
[Demo](https://ghiscoding.github.io/angular-slickgrid-demos/#/example30) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/example30.component.ts)
