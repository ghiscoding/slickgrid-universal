...
### Demo
[Demo Parent/Child Relationship](https://ghiscoding.github.io/angular-slickgrid-demos/#/example27) / [Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/example27.component.ts)

[Hierarchial Dataset](https://ghiscoding.github.io/angular-slickgrid-demos/#/example28) / [Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/example28.component.ts)
