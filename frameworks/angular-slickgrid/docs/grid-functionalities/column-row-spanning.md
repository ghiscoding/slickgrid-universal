...
#### Colspan / Rowspan
[Employee Timesheets](https://ghiscoding.github.io/angular-slickgrid-demos/#/example43) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/example43.component.ts)

[Large Dataset](https://ghiscoding.github.io/angular-slickgrid-demos/#/example44) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/example44.component.ts)
