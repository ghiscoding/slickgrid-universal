...
### Demo
[Demo Page](https://ghiscoding.github.io/angular-slickgrid-demos/#/custom-tooltip) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/grid-custom-tooltip.component.ts)
