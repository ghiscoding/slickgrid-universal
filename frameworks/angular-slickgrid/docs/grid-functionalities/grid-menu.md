...
### Demo
[Demo Page](https://ghiscoding.github.io/angular-slickgrid-demos/#/example09) / [Demo ViewModel](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/example09.component.ts)
