...
### Demo
[Demo](https://ghiscoding.github.io/angular-slickgrid-demos/#/example24) / [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/example24.component.ts)
