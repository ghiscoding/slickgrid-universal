...
### Demo
[Demo Page](https://ghiscoding.github.io/angular-slickgrid-demos/#/example03) | [Demo Component](https://github.com/ghiscoding/slickgrid-universal/blob/master/frameworks/angular-slickgrid/src/demos/examples/example03.component.ts) - ("Title" column to be more specific)
