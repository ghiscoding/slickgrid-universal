...
|:---------------:| --------- | --------------- | ----- | ---- |
| 10.x            | Vue >=3.5.0 | [Migration 10.x](https://ghiscoding.gitbook.io/slickgrid-vue/migrations/migration-to-10.x)  | simplification, modernization and accessibility, requires Slickgrid-Universal [10.x](https://github.com/ghiscoding/slickgrid-universal/releases/tag/v10.0.0) | 2026-03-02 |
