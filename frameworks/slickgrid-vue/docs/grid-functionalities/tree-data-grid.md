...
### Demo
[Demo Parent/Child Relationship](https://ghiscoding.github.io/slickgrid-vue/#/slickgrid/Example27) / [ViewModel](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/vue/src/components/Example27.vue)

[Hierarchial Dataset](https://ghiscoding.github.io/slickgrid-vue/#/slickgrid/Example28) / [ViewModel](https://github.com/ghiscoding/slickgrid-universal/blob/master/demos/vue/src/components/Example28.vue)
...
function defineGrid() {
  ...
  datasetHierarchical.value = getData();
}

function getData() {
  datasetHierarchical.value = [
...
You would typically use the built-in `Formatters.tree` to show the tree but in some cases you might want to use your own Formatter and that is fine, it's like any other Custom Formatter. Here's a demo of the [Example 28](https://ghiscoding.github.io/slickgrid-vue/#/slickgrid/Example28) Custom Formatter which is specific for showing the collapsing icon and folder and files icons.
