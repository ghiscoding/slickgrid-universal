...
> [!NOTE]
> #### Follow the [Migration to 9.0](https://ghiscoding.gitbook.io/slickgrid-react/migrations/migration-to-9.x) for all the changes and take a look at the [v9.0.0](https://github.com/ghiscoding/slickgrid-universal/releases/tag/v9.0.0) release for the announcement and quick info.
