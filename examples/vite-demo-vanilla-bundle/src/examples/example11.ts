  ...
  initializeGrid() {
    this.columnDefinitions = [
      ...
      },
      {
        ...
        formatter: () => `<span class="button-style padding-1px action-btns"title"Delete the Row"><span class="sgi sgi-close text-color-danger" title="Delete Current Row"></span></span>
