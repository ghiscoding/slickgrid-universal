  ...
  initializeGrid() {
    ...
    this.columnDefinitions = [
      ...
      },
      {
        ...
        editor: {
          ...
          collection: Array.from(Array(101).keys()).map(k => ({ value: k, label: k, symbol: '<i class="sgi sgi-percent-outline text-color-info"></i>' })),
          customStructure: {
            value: 'value',
            label: 'label',
            labelSuffix: 'symbol'
    ...
    this.gridOptions = {
      ...
      contextMenu: {
        ...
        optionItems: [
          { option: 0, iconCssClass: 'sgi sgi-checkbox-blank-outline text-color-secondary', title: 'Not Started (0%)' },
          { option: 50, iconCssClass: 'sgi sgi-flip-vertical', title: 'Half Completed (50%)' },
          { option: 100, iconCssClass: 'sgi sgi-checkbox-marked text-color-success', title: 'Completed (100%)' },
          'divider',
          {
