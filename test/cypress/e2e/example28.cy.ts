describe('Example 28 - Infinite Scroll from JSON data', () => {
  ...
  it('should display Example title', () => {
    ...
    cy.get('h3').should('contain', 'Example 28 - Infinite Scroll from JSON data');
  });
  ...
  it('should expect first row to include "Task 0" and other specific properties', () => {
    ...
    cy.get(`[style="transform: translateY(${GRID_ROW_HEIGHT * 0}px);"] > .slick-cell:nth(3)`).contains('2020');
    cy.get(`[style="transform: translateY(${GRID_ROW_HEIGHT * 0}px);"] > .slick-cell:nth(4)`).contains('2022');
