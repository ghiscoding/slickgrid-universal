describe('Example 16 - Regular & Custom Tooltips', () => {
  ...
  it('should change filters dynamically with just "=" filter and expect rows with empty descriptions', () => {
    ...
    cy.get('[data-row="0"] > .slick-cell:nth(4) span').should('be.empty');
    cy.get('[data-row="1"] > .slick-cell:nth(4) span').should('be.empty');
    cy.get('[data-row="2"] > .slick-cell:nth(4) span').should('be.empty');
    cy.get('[data-row="3"] > .slick-cell:nth(4) span').should('be.empty');
    cy.get('[data-row="4"] > .slick-cell:nth(4) span').should('be.empty');
  });
  ...
  it('should change filters dynamically with just "!=" filter and expect rows with non-empty descriptions', () => {
    ...
    cy.get('[data-row="0"] > .slick-cell:nth(4) span').should('not.be.empty');
    cy.get('[data-row="1"] > .slick-cell:nth(4) span').should('not.be.empty');
    cy.get('[data-row="2"] > .slick-cell:nth(4) span').should('not.be.empty');
    cy.get('[data-row="3"] > .slick-cell:nth(4) span').should('not.be.empty');
    cy.get('[data-row="4"] > .slick-cell:nth(4) span').should('not.be.empty');
  });
});
